...
var renderClientChildren_1 = __importDefault(require("./renderClientChildren"));
...
function handleRender(_a) {
    ...
    if (isPromise(targetContent)) {
        var translationPromise = (function () { return __awaiter(_this, void 0, void 0, function () {
            var resolved;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, targetContent];
                    case 1:
                        resolved = _a.sent();
                        return [2 /*return*/, (0, renderClientChildren_1.default)(__assign({ source: source, target: resolved }, metadata))];
                }
            });
        }); })();
    ...
    return (0, renderClientChildren_1.default)(__assign({ source: source, target: targetContent }, metadata));
}
