...
function renderTranslatedElement(_a) {
    ...
    if (transformation === "branch") {
        ...
        return react_1.default.createElement('span', __assign(__assign({}, props), { 'data-generaltranslation': undefined, suppressHydrationWarning: true, children: renderTranslatedChildren({
                source: sourceBranch,
                target: targetBranch,
                variables: variables,
                variablesOptions: variablesOptions,
