...
function DateTime(_a) {
    ...
    return ((0, jsx_runtime_1.jsx)("span", { "data-_gt-variable-name": name, "data-_gt-variable-type": "date", "data-_gt-variable-options": options, style: { display: 'contents' }, suppressHydrationWarning: true, children: final }));
}
;
