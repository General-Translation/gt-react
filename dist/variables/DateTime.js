...
function DateTime(_a) {
    ...
    return ((0, jsx_runtime_1.jsx)("span", { "data-generaltranslation": generaltranslation, "data-_gt-variable-name": name, "data-_gt-variable-type": "date", "data-_gt-variable-options": options, "data-_gt-unformatted-value": isValidDate(dateValue) ? dateValue : undefined, children: formattedValue }));
}
;
