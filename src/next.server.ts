import { initGT as initBaseGT, initVariables as initBaseVariables } from "./server-index";
...
export function initGT({
    ...
    return initBaseGT({ defaultLocale, getLocale: finalGetLocale, getMetadata: finalGetMetadata, ...metadata });
}
...
export function initVariables({
    ...
    const finalGetLocale = getLocale || (() => { return getNextLocale(defaultLocale, approvedLocales) });
    return initBaseVariables({ approvedLocales, defaultLocale, getLocale: finalGetLocale });
}