  ...
  if (React.isValidElement(child)) {
    ...
    if (props['data-_gt']) {
      ...
      if (transformation === 'variable') {
        const variableName =
          props.name ||
          (defaultVariableNames as any)[generaltranslation?.variableType] ||
          'value';
        return {
          variable: generaltranslation.variableType || 'variable',
          key: variableName,
        };
      }
 ...
 * Also strips all props except for GT props, children, and type.
